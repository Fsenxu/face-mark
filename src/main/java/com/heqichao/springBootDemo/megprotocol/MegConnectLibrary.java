...
public interface MegConnectLibrary extends Library {
    ...
    public static class MegConnInitParamStruct extends Structure {
        ...
        @Override
        protected List<String> getFieldOrder() {
            return Arrays.asList("type", "rpc_svr_url", "https_svr_url", "http_svr_url", "onvif_multicast_ip", "crt_path", "key_path",
                    "svr_status_cb", "check_param_enc_cb", "get_activation_status_cb", "activate_device_cb", "authority_cb", "cli_status_cb",
                    "need_active_server", "active_svr_url", "reg_check_cb", "com_free");
        }
    }
