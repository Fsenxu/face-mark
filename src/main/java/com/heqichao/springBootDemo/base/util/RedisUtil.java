...
public  class RedisUtil {
    ...
    private static RedisTemplate<String, Object> getRedisTrmplate(){//为保证volatile关键字正常执行，使用double check
     ...
     * @return
     */
    public static  int sGetSetCollection(String key,List<String> otherKeys ) {
    	if(StringUtil.isEmpty(key)){
    		return 0;
    	}
    	try {
    		return getRedisTrmplate().opsForSet().union(key, otherKeys).size();
    	} catch (Exception e) {
    		e.printStackTrace();
    		return 0;
    	}
     ...
     * @return
     */
    public static  int sGetSetCollectionSize(String key,List<String> otherKeys ) {
    	if(StringUtil.isEmpty(key)){
    		return 0;
    	}
    	try {
    ...
    public static  Boolean zAdd(String key, Object value, double score) {
        ...
        try {
            return getRedisTrmplate().opsForZSet().add(key, value, score);
        } catch (Exception e) {
            e.printStackTrace();
            return false;
        }
    ...
    public static  Boolean zAddAndTime(String key, long time, Object value, double score) {
        if(StringUtil.isEmpty(key)){
            return false;
        }
        try {
        	 getRedisTrmplate().opsForZSet().add(key, value, score);
            if (time > 0) {
                expire(key, time);
            }
            return true;
     ...
     * @return
     */
    public static  List<Object> zReverseRange(String key, long start, long end) {
        if(StringUtil.isEmpty(key)){
            return new ArrayList<>();
        }
        try {
        	Set<Object> res = getRedisTrmplate().opsForZSet().reverseRange(key, start, end);
        	List<Object> resList = new ArrayList<>(res);
            return resList;
        } catch (Exception e) {
            e.printStackTrace();
            return new ArrayList<>();
    ...
    public static Double zScore(String key, Object value) {
    	...
    	try {
    		return getRedisTrmplate().opsForZSet().score(key, value);
    	} catch (Exception e) {
    		e.printStackTrace();
    		return 0D;
    	}
    ...
    public static  long reverseRank(String key, Object value) {
    	...
    	try {
    		return getRedisTrmplate().opsForZSet().reverseRank(key, value);
    	} catch (Exception e) {
    		e.printStackTrace();
    		return 0L;
    	}
    ...
    public static  long zRemove(String key,  Object... value) {
        ...
        try {
            Long remove = getRedisTrmplate().opsForZSet().remove(key, value);
            return remove;
        } catch (Exception e) {
            e.printStackTrace();
            return 0L;
